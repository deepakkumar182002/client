          ...
          <div className='p-1 border-2 h-screen border-gray-200 border-dashed rounded-lg dark:border-gray-700'>
            ...
            >
              <div className=' h-full w-60 m-0 p-0 md:w-full lg:w-full'>
                ...
                <p className="text-dark-green mt-4">{expData.titleDes}</p>
                <p
                ...
                <Image className='m-auto mt-4' src={expData.projectImg} height={300} width={600} alt="" />
                ...
                <h4 className='heading  text-3xl font-bold'>Project Tutorial:</h4>
                {/* <iframe width="560" height="315" src={expData.tutorial} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> */}

                <ReactPlayer
                  className="m-auto mt-4"
                  width="560px"
                  height="315px"
                  url={expData.tutorial}
                  controls={true}
              ...
              <div className='md:w-full m-auto mt-4 lg:w-80 w-[250px] md:h-[400px] h-auto flex flex-wrap mr-4 md:p-4'>
                <div
